...
import com.example.atelier4.mappers.BankAccountMapperImpl;
...
@Service
@Transactional //annotaion transaction de spting
@AllArgsConstructor
@Slf4j //pour logger un message avec log.info("...")
...
public class BankAccountServiceImpl implements BankAccountService{
    ...
    public List<CustomerDTO> listCustomer() {
        ...
        List<CustomerDTO> collect = customers.stream().
                ...
                collect(Collectors.toList()); //pour chaque customer je le remplace avec customerdto
        return collect;
    }
    ...
    public AccountHistoryDTO getAccountHistory(String accountId, int page, int size) throws BankAccountNotFoundException {
        ...
        List<AccountOperationDTO> accountOperationDTOS=accountOperation.getContent().
                stream().map(op->dtoMapper.fromAccountOperation(op)).collect(Collectors.toList());
